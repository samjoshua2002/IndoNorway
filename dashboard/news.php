                        ...
                        <table class="table table-hover table-custom mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th><a href="#" class="sort-link" data-sort="title">Title <span
                                                id="sort-icon-title"><?php echo sortIcon('title', $sort, $order); ?></span></a>
                                    </th>
                                    <th><a href="#" class="sort-link" data-sort="tag">Tag <span
                                                id="sort-icon-tag"><?php echo sortIcon('tag', $sort, $order); ?></span></a>
                                    </th>
                                    <th><a href="#" class="sort-link" data-sort="event_date">Date <span
                                                id="sort-icon-event_date"><?php echo sortIcon('event_date', $sort, $order); ?></span></a>
                                    </th>
                            ...
                            <tbody id="table-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                $imgSrc = ($row['image'] && file_exists("../assets/files/news/" . $row['image']))
                                                    ...
                                                    : "../assets/files/people/placeholder.png";
                                                ?>
                                                <img src="<?php echo $imgSrc; ?>" alt="News"
                                            ...
                                            <td><span
                                                    class="badge bg-secondary"><?php echo htmlspecialchars($row['tag'] ?? 'N/A'); ?></span>
                                            </td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center py-4 text-muted">No news or events found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
