...
// Fetch banners
$sql = "SELECT * FROM herobanner ORDER BY id ASC";
...
<head>
    ...
    <title>Manage Banners - IndoNorway Connect</title>
    <!-- Fonts -->
    <link
    ...
    <div class="content-wrapper">
        ...
        <main class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 style="font-family: 'Figtree', sans-serif;">Manage Banners</h2>
                <a href="edit-banner.php" class="btn btn-primary"
                                ...
                                <?php if ($result && $result->num_rows > 0): ?>
                                    ...
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="edit-banner.php?id=<?php echo $row['id']; ?>"
                                                    class="btn btn-sm btn-outline-primary me-1">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="delete-banner.php?id=<?php echo $row['id']; ?>"
