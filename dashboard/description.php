...
<head>
    ...
    <title>Manage Description - IndoNorway Connect</title>
    <!-- Fonts -->
    <link
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-custom mb-0">
                            ...
                            <tbody>
                                <?php if ($result && $result->num_rows > 0): ?>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <!-- Limit text length -->
                                            <td>
                                                <?php echo htmlspecialchars(mb_strimwidth($row['about'], 0, 100, "...")); ?>
                                            </td>
                                            <td class="text-end">
                                                <a href="edit-description.php?id=<?php echo $row['id']; ?>"
                                                    class="btn btn-sm btn-outline-primary me-1">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="delete-description.php?id=<?php echo $row['id']; ?>"
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="text-center py-4 text-muted">No content found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
